	...
	private_oqs_plugin_t *this, plugin_feature_t *features[])
{
	static plugin_feature_t f[] = {
		...
		PLUGIN_REGISTER(QSKE, oqs_qske_create),
			...
			PLUGIN_PROVIDE(QSKE, QSKE_SIKE_L2),
			PLUGIN_PROVIDE(QSKE, QSKE_SIKE_L3),
			PLUGIN_PROVIDE(QSKE, QSKE_SIKE_L5),
			PLUGIN_PROVIDE(QSKE, QSKE_NTRU_HPS_L1),
			PLUGIN_PROVIDE(QSKE, QSKE_NTRU_HPS_L3),
			PLUGIN_PROVIDE(QSKE, QSKE_NTRU_HPS_L5),
			PLUGIN_PROVIDE(QSKE, QSKE_NTRU_HRSS_L3),
